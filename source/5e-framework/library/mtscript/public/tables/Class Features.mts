...
[r,count(listcount(classlist),""),code:{
	...
	[r:macroLink(CapitalName,"Class Window@Lib:Tables","","class="+currentClass)]
	[r,if(name==currentClass):"</b>"]
	<br>
	...
	[r,count(listcount(subclassList),""),code:{
		...
		[r:macroLink(CapitalName,"Class Window@Lib:Tables","","class="+currentClass+";subclass="+currentSubclass)]
		[r,if(name==currentSubclass):"</b>"]
		<br>
...
<font size=3>
	[r:macroLink("Edit","Change Form@Lib:Character","","prop="+if(isAddFeat==1,"AdditionalFeats","Feats")+";source=;name="+name+";description=;tokenName=Lib:Campaign")] |
[r:macrolink("Move","Move@Lib:Character","","tokenName=Lib:Compendium;description=;name="+name+";prop="+if(isAddFeat==1,"AdditionalFeats","Feats"))]
