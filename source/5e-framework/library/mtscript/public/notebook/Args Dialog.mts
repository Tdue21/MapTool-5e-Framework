[h:macro.args  = setStrProp(macro.args,"tokenName","Lib:Compendium")]
...
[dialog5(if(share==1,"",tokenName+" - ")+CapitalName, "width=450; height="+height+"; temporary=0; noframe=0; input=1"):{
	...
	[macro("notebook/Markdown@this"):"tokenName="+tokenName+";description="+description+";source="+source+";name="+name+";group="+group]
