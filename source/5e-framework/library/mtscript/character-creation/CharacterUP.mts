...
Select in the list below the <b>Token</b> to level up, the list shows only <b>PC tokens</b>, if a token is not shown, be sure it is set as PC token and you are the token's owner.
...
<input type="hidden" name="window" value="CharacterUP">
