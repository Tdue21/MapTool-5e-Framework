...
[h:attributeList=getProperty("Attributes",id)]
[h:atrList=""]
...
[h:maxValue=""]
[h,count(countMax):maxValue=listappend(maxValue,getStrProp(getProperty(listget(attributeList,listfind(atrList,listget(group4,roll.count,"|")))),"value"))]
