...
[h,count(listcount(fields)),code:{
    ...
    [h,if(CurrentBuff=="concentration"),code:{
        [h:BuffDescription=name+if(unit=="minute"||unit=="round"," (ends in "+roundEnd+" Round"+if(roundEnd==1,")","s)"),""))]
...
[h:res=input("All buffs | Buffs || TAB", 
...
[h,if(remove=="-"),code:{};{
    ...
    [h,if(remove=="concentration"):setProperty("Concentration",0)]
    [h:Buffs=json.remove(Buffs,remove)]
}]

[h:setProperty("Buffs",Buffs)]
