...
[h:bonusDmg=if(levelRolls-roll.count>0,bonusDmg,0)]
	...
	[h:entry=replace(entry,"ROLLPLACEHOLDER\\d+","<span title='roll: "+group2+"'>"+macroLink(group1,"notebook/Dice Roller@this","","text="+group1+";value="+group2+";tokenName="+tokenName)+"</span>",1)]
}]
...
[h,count(getFindCount(id)),code:{
	...
	[h:entry=replace(entry,"TOHITPLACEHOLDER\\d+","<span title='to hit: "+group2+"'>"+macroLink(group1,"notebook/d20 Roller@this","","text="+text+";value=("+if(group2<0,group2,"+"+group2)+");tokenName="+tokenName+";color=red")+"</span>",1)]
}]
[h:entry=replace(entry,"PLUSPLACEHOLDER","+")]
