...
[h:skillAvailable="Arcana,Deception,Insight,Intimidation,Persuasion,Religion"]
...
[h,count(repeat,""),code:{
	...
	[h,if(saveName=="Constitution" || saveName=="Charisma"):currentSave=json.set(currentSave,"prof",if(SaveProf==0,1,SaveProf))]
...
[r,if(Equip=="Starting Equipment"),code:{
	...
	"weapon2|Two Daggers|Other|label")]
	[h:abort(res)]
