...
[h:skillAvailable="Acrobatics,Animal Handling,Athletics,History,Insight,Intimidation,Perception,Survival"]
...
[h:resourcesObj=json.set(resourcesObj,"second wind",json.fromStrProp("value=0;total=1;reset=0"))]
...
[r,if(Equip=="Starting Equipment"),code:{
	...
	"armor|Chain Mail,Leather Armor; Longbow and 20 arrows|Weapon|list",
	"weapon1|Martial Weapon and Shield,2 Martial Weapons|Weapon 1|list",
	"weapon2|Light Crossbow and 20 bolts,2 Handaxes|Weapon 2|list",
...
[r,if(level==2),code:{
	...
	[h:resourcesObj=json.set(resourcesObj,"action surge",json.fromStrProp("value=0;total=1;reset=0"))]
...
[r,if(level==9),code:{
	...
	[h:resourcesObj=json.set(resourcesObj,"indomitable",json.fromStrProp("value=0;total=1;reset=1"))]
...
[r,if(level==13),code:{
	...
	[h:resourcesObj=json.set(resourcesObj,"indomitable",json.fromStrProp("value=0;total=2;reset=1"))]
...
[r,if(level==17),code:{
	...
	[h:resourcesObj=json.set(resourcesObj,"indomitable",json.fromStrProp("value=0;total=3;reset=1"))]
	[h:resourcesObj=json.set(resourcesObj,"action surge",json.fromStrProp("value=0;total=2;reset=0"))]
