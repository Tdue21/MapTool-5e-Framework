...
[h:CapitalName=replace(CapitalName,"'S(?=\\s)","'s")]
	...
	[r:macroLink(CapitalName,"Args Dialog@Lib:Character","","prop=Equipment;name="+name+";description=;tokenName=Compendium")]
	<td width=0% align=right>

	[r:json.toList(json.get(currentObj,"sources"))]
	
	<font size=2 color=red>[r:macroLink("X","Delete Source@Lib:Character","","prop=Equipment;name="+name+";tokenName="+tokenName)]</font>
	
}]
</table>

[r:macrolink("+","Args Dialog@Lib:Character","","prop=Equipment;index=new;name=new;description=new;tokenName="+tokenName)]