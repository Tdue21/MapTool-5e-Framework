...
[h,switch(medium):
case 1:share=macroLinkText("Shared Info@Lib:Character", "none", macro.args);
case 2:share=macroLinkText("Shared PC Info@Lib:Overlay", "none", macro.args);
default:share="Info: <a style='text-decoration:none' href='"+macroLinkText("Shared Info@Lib:Character", "none", macro.args)+"'>"+tokenName+"</a>"]
